...
function checkValidate(){
	...
	<div class="maincontent-page">
		<div class="card p-4">
			<div class="custom-tab">
				<ul class="nav nav-pills custom-navpills">
					<li class="nav-item"><a class="nav-link"
						...
						aria-current="page" href="editSportsClub;">Edit</a></li>
			...
			<form:form action="updateSportsClub" modelAttribute="SportsClub"
					...
					<div class="col-sm-6 col-lg-4 col-xl-4 col-xxl-3 ">
						...
						<div class="input-group">
							<input type="text"
								...
								id="dob_id" value="${date}" placeholder="Please Right Click to Enter Your DOB">
...
<!-- 														</div> -->
					...
					<div class="col-sm-12 col-md-4 col-lg-4 col-xl-4 col-xxl-3">
						<label for="driver_name" class="form-label d-block">Upload
							Photo</label>
							 <input type="file" name="image" id="file_id" value="${image_path}"/>
					</div>
				</div>
				<div class="row">
					<div class="fs-6">
					<div><br></div>
						<button type="submit" class="btn btn-success px-3 py-1 rounded" onclick="return checkValidate();">Update</button>
